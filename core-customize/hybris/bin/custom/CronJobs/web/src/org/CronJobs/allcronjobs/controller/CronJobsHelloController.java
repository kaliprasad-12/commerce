 ...
 */
package org.CronJobs.allcronjobs.controller;
...
@Controller
public class CronJobsHelloController
{
	@Autowired
	...
	{
		model.addAttribute("logoUrl", CronJobsService.getHybrisLogoUrl(PLATFORM_LOGO_CODE));
		return "welcome";
	}
}
