...
public class DefaultCronJobsService implements CronJobsService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultCronJobsService.class);
	...
	{
		return DefaultCronJobsService.class.getResourceAsStream("/CronJobs/sap-hybris-platform.png");
	}
